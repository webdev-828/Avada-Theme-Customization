		...
		class AvadaReduxFramework_dimensions {
			...
			function enqueue() {
				...
				wp_enqueue_script(
					...
					AvadaReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions' . AvadaRedux_Functions::isMin() . '.js',
				...
				if ( $this->parent->args['dev_mode'] ) {
					wp_enqueue_style(
						...
						AvadaReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions.css',
						array(),
						time(),
						'all'
					);
