...
// Don't duplicate me!
if ( ! class_exists( 'AvadaReduxFramework_border' ) ) {

	class AvadaReduxFramework_border {
		...
		function render() {
			...
			if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
				echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="avadaredux-border-all avadaredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'All', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
			}

			echo '<input type="hidden" class="avadaredux-border-value" id="' . $this->field['id'] . '-top" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-top]" value="' . ( isset($this->value['top']) ? $this->value['top'] . 'px' : '' ) . '">';
			echo '<input type="hidden" class="avadaredux-border-value" id="' . $this->field['id'] . '-right" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-right]" value="' . ( isset($this->value['right']) ? $this->value['right'] . 'px' : '' ) . '">';
			echo '<input type="hidden" class="avadaredux-border-value" id="' . $this->field['id'] . '-bottom" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-bottom]" value="' . ( isset($this->value['bottom']) ? $this->value['bottom'] . 'px' : '' ) . '">';
			echo '<input type="hidden" class="avadaredux-border-value" id="' . $this->field['id'] . '-left" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-left]" value="' . ( isset($this->value['left']) ? $this->value['left'] . 'px' : '' ) . '">';
			...
			if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
				...
				if ( $this->field['top'] === true ) {
					echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="avadaredux-border-top avadaredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Top', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
				}
				...
				if ( $this->field['right'] === true ) {
					echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="avadaredux-border-right avadaredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Right', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
				}
				...
				if ( $this->field['bottom'] === true ) {
					echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="avadaredux-border-bottom avadaredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
				}
				...
				if ( $this->field['left'] === true ) {
					echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="avadaredux-border-left avadaredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
				}
			}
			...
			if ( $this->field['style'] != false ) {
				...
				echo '<select original-title="' . __( 'Border style', 'avadaredux-framework' ) . '" id="' . $this->field['id'] . '[border-style]" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-style]" class="tips avadaredux-border-style ' . $this->field['class'] . '" rows="6" data-id="' . $this->field['id'] . '">';
			...
			if ( $this->field['color'] != false ) {
				...
				echo '<input name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-color]" id="' . $this->field['id'] . '-border" class="avadaredux-border-color avadaredux-color avadaredux-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['color'] . '"  data-default-color="' . $default . '" data-id="' . $this->field['id'] . '" />';
			} else {
		...
		function enqueue() {
			...
			if (!wp_script_is ( 'avadaredux-field-border-js' )) {
				wp_enqueue_script(
					'avadaredux-field-border-js',
					AvadaReduxFramework::$_url . 'inc/fields/border/field_border' . $min . '.js',
					array( 'jquery', 'select2-js', 'wp-color-picker', 'avadaredux-js' ),
					time(),
					true
				);
			}
			...
			if ($this->parent->args['dev_mode']) {
				...
				if (!wp_style_is ( 'avadaredux-field-border-css' )) {
					wp_enqueue_style(
						'avadaredux-field-border-css',
						AvadaReduxFramework::$_url . 'inc/fields/border/field_border.css',
						array(),
						time(),
						'all'
					);
