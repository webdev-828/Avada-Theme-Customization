...
// Don't duplicate me!
if ( ! class_exists( 'AvadaReduxFramework_media' ) ) {

	/**
	 * Main AvadaReduxFramework_media class
	 *
	 * @since       1.0.0
	 */
	class AvadaReduxFramework_media {
		...
		public function render() {
			...
			echo '<img class="avadaredux-option-image" id="image_' . $this->field['id'] . '" src="' . $this->value['thumbnail'] . '" alt="" target="_blank" rel="external" />';
			echo '</a>';
			echo '</div>';
			...
			echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'avadaredux-framework' ) . '</span>';
			...
			echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'avadaredux-framework' ) . '</span>';
