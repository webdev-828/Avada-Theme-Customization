...
// Don't duplicate me!
	if ( ! class_exists( 'AvadaReduxFramework_Extension_options_object' ) ) {


		/**
		 * Main AvadaReduxFramework options_object extension class
		 *
		 * @since       3.1.6
		 */
		class AvadaReduxFramework_Extension_options_object {
			...
			public function add_section() {
				$this->parent->sections[] = array(
					'id' => 'options-object',
					'title' => __( 'Options Object', 'avadaredux-framework' ),
					'heading' => '',
					'icon' => 'el el-info-circle',
					'customizer' => false,
					'fields' => array(
						array(
							'id' => 'avadaredux_options_object',
							'type'=> 'options_object',
							'title' => '',
						)
					),
