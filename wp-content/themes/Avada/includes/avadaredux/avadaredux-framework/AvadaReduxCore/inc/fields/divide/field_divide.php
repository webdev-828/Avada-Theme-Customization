...
// Don't duplicate me!
if ( !class_exists ( 'AvadaReduxFramework_divide' ) ) {

	/**
	 * Main AvadaReduxFramework_divide class
	 *
	 * @since       1.0.0
	 */
	class AvadaReduxFramework_divide {
		...
		public function enqueue() {
			if ($this->parent->args['dev_mode']) {
				wp_enqueue_style(
					'avadaredux-field-divide',
					AvadaReduxFramework::$_url . 'inc/fields/divide/field_divide.css',
					array(),
					time(),
					'all'
				);
