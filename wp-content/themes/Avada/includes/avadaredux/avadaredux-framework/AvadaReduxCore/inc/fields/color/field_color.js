...
//				var $control = el.find( '.avadaredux-color-init' ),
//
...
//				$( '<div class="avadaredux-alpha-container">'
...
//                                //console.log($alpha);
//				$alpha_output = $control.parents( '.wp-picker-container:first' ).find( '.avadaredux-alpha-container output' );
...
//                                        el.find( '.avadaredux-color-init' ).wpColorPicker( 'color', iris._color.toString() );
