...
// Don't duplicate me!
if ( !class_exists ( 'AvadaReduxFramework_checkbox' ) ) {

	/**
	 * Main AvadaReduxFramework_checkbox class
	 *
	 * @since       1.0.0
	 */
	class AvadaReduxFramework_checkbox {
		...
		public function enqueue () {
			...
			if ($this->parent->args['dev_mode']) {
				wp_enqueue_style (
					'avadaredux-field-checkbox-css',
					AvadaReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox.css',
					array(),
					time (),
					'all'
				);
			...
			wp_enqueue_script (
				'avadaredux-field-checkbox-js',
				AvadaReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox' . AvadaRedux_Functions::isMin () . '.js',
