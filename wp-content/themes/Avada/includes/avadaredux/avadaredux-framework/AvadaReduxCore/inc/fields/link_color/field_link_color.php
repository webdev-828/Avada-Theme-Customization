...
// Don't duplicate me!
if ( ! class_exists( 'AvadaReduxFramework_link_color' ) ) {

	/**
	 * Main AvadaReduxFramework_link_color class
	 *
	 * @since       1.0.0
	 */
	class AvadaReduxFramework_link_color {
		...
		public function render() {
			...
			if ( $this->field['regular'] === true && $this->field['default']['regular'] !== false ) {
				echo '<span class="linkColor"><strong>' . __( 'Regular', 'avadaredux-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-regular" name="' . $this->field['name'] . $this->field['name_suffix'] . '[regular]' . '" value="' . $this->value['regular'] . '" class="avadaredux-color avadaredux-color-regular avadaredux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['regular'] . '" /></span>';
			}

			if ( $this->field['hover'] === true && $this->field['default']['hover'] !== false ) {
				echo '<span class="linkColor"><strong>' . __( 'Hover', 'avadaredux-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . $this->field['name_suffix'] . '[hover]' . '" value="' . $this->value['hover'] . '" class="avadaredux-color avadaredux-color-hover avadaredux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['hover'] . '" /></span>';
			}

			if ( $this->field['visited'] === true && $this->field['default']['visited'] !== false ) {
				echo '<span class="linkColor"><strong>' . __( 'Visited', 'avadaredux-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-hover" name="' . $this->field['name'] . $this->field['name_suffix'] . '[visited]' . '" value="' . $this->value['visited'] . '" class="avadaredux-color avadaredux-color-visited avadaredux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['visited'] . '" /></span>';
			}

			if ( $this->field['active'] === true && $this->field['default']['active'] !== false ) {
				echo '<span class="linkColor"><strong>' . __( 'Active', 'avadaredux-framework' ) . '</strong>&nbsp;<input id="' . $this->field['id'] . '-active" name="' . $this->field['name'] . $this->field['name_suffix'] . '[active]' . '" value="' . $this->value['active'] . '" class="avadaredux-color avadaredux-color-active avadaredux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['active'] . '" /></span>';
			}
		}
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				'avadaredux-field-link-color-js',
				AvadaReduxFramework::$_url . 'inc/fields/link_color/field_link_color' . AvadaRedux_Functions::isMin() . '.js',
			...
			if ($this->parent->args['dev_mode']) {
				...
				wp_enqueue_style(
					'avadaredux-field-link_color-js',
					AvadaReduxFramework::$_url . 'inc/fields/link_color/field_link_color.css',
					array(),
					time(),
					'all'
				);
