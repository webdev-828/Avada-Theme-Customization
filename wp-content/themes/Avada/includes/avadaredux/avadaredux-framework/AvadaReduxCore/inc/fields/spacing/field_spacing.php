...
if ( ! class_exists( 'AvadaReduxFramework_spacing' ) ) {
	class AvadaReduxFramework_spacing {
		...
		function render() {
			...
			if ( isset( $this->field['units'] ) && ! AvadaRedux_Helpers::array_in_array( $this->field['units'], array(
						'',
						false,
						'%',
						'in',
			...
			if ( isset( $this->value['units'] ) && ! AvadaRedux_Helpers::array_in_array( $this->value['units'], array(
						'',
						'%',
						'in',
						'cm',
...
//            }
			...
			if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
				echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="avadaredux-spacing-all avadaredux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'All', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
			}

			if ( $this->field['top'] === true ) {
				echo '<input type="hidden" class="avadaredux-spacing-value" id="' . $this->field['id'] . '-top" name="' . $this->field['name'] . $this->field['name_suffix'] . '[' . $this->field['mode'] . 'top]' . '" value="' . $this->value['top'] . ( ! empty( $this->value['top'] ) ? $this->value['units'] : '' ) . '">';
			}

			if ( $this->field['right'] === true ) {
				echo '<input type="hidden" class="avadaredux-spacing-value" id="' . $this->field['id'] . '-right" name="' . $this->field['name'] . $this->field['name_suffix'] . '[' . $this->field['mode'] . 'right]' . '" value="' . $this->value['right'] . ( ! empty( $this->value['right'] ) ? $this->value['units'] : '' ) . '">';
			}

			if ( $this->field['bottom'] === true ) {
				echo '<input type="hidden" class="avadaredux-spacing-value" id="' . $this->field['id'] . '-bottom" name="' . $this->field['name'] . $this->field['name_suffix'] . '[' . $this->field['mode'] . 'bottom]' . '" value="' . $this->value['bottom'] . ( ! empty( $this->value['bottom'] ) ? $this->value['units'] : '' ) . '">';
			}

			if ( $this->field['left'] === true ) {
				echo '<input type="hidden" class="avadaredux-spacing-value" id="' . $this->field['id'] . '-left" name="' . $this->field['name'] . $this->field['name_suffix'] . '[' . $this->field['mode'] . 'left]' . '" value="' . $this->value['left'] . ( ! empty( $this->value['left'] ) ? $this->value['units'] : '' ) . '">';
			}
			...
			if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
				 ...
				 * */
				if ( $this->field['top'] === true ) {
					echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="avadaredux-spacing-top avadaredux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Top', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
				}
				 ...
				 * */
				if ( $this->field['right'] === true ) {
					echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="avadaredux-spacing-right avadaredux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Right', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
				}
				 ...
				 * */
				if ( $this->field['bottom'] === true ) {
					echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="avadaredux-spacing-bottom avadaredux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
				}
				 ...
				 * */
				if ( $this->field['left'] === true ) {
					echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="avadaredux-spacing-left avadaredux-spacing-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'avadaredux-framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
				}
			}
			...
			if ( $this->field['units'] !== false && is_array( $this->field['units'] ) /* && !isset($absolute) */ && $this->field['display_units'] == true ) {
				...
				echo '<div class="select_wrapper spacing-units" original-title="' . __( 'Units', 'avadaredux-framework' ) . '">';
				echo '<select data-placeholder="' . __( 'Units', 'avadaredux-framework' ) . '" class="avadaredux-spacing avadaredux-spacing-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'avadaredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '" id="' . $this->field['id'] . '_units">';
		...
		function enqueue() {
			...
			wp_enqueue_script(
				'avadaredux-field-spacing-js',
				AvadaReduxFramework::$_url . 'inc/fields/spacing/field_spacing' . AvadaRedux_Functions::isMin() . '.js',
			...
			if ($this->parent->args['dev_mode']) {
				wp_enqueue_style(
					'avadaredux-field-spacing-css',
					AvadaReduxFramework::$_url . 'inc/fields/spacing/field_spacing.css',
					array(),
					time(),
					'all'
				);
