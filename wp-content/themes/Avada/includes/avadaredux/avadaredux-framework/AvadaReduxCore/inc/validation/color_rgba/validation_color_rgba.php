<?php
	if ( ! class_exists( 'AvadaRedux_Validation_color_rgba' ) ) {
		class AvadaRedux_Validation_color_rgba {
			...
			function __construct( $parent, $field, $value, $current ) {
				$this->parent       = $parent;
				$this->field        = $field;
				$this->field['msg'] = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : __( 'This field must be a valid color value.', 'avadaredux-framework' );
				$this->value        = $value;
