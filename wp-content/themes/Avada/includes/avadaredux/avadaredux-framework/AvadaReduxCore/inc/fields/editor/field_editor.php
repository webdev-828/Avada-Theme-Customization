...
// Don't duplicate me!
if ( ! class_exists( 'AvadaReduxFramework_editor' ) ) {

	/**
	 * Main AvadaReduxFramework_editor class
	 *
	 * @since       1.0.0
	 */
	class AvadaReduxFramework_editor {
		...
		public function enqueue() {
			if ($this->parent->args['dev_mode']) {
				wp_enqueue_style(
					'avadaredux-field-editor-css',
					AvadaReduxFramework::$_url . 'inc/fields/editor/field_editor.css',
					array(),
					time(),
					'all'
				);
			...
			wp_enqueue_script(
				'avadaredux-field-editor-js',
				AvadaReduxFramework::$_url . 'inc/fields/editor/field_editor' . AvadaRedux_Functions::isMin() . '.js',
