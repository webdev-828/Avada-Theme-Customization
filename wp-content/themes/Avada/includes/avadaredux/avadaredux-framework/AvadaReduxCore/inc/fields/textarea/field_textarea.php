<?php
	 ...
	 * @link        http://avadareduxframework.com
	 * @method      Test
...
// Exit if accessed directly
	...
	if ( ! class_exists( 'AvadaReduxFramework_textarea' ) ) {
		class AvadaReduxFramework_textarea {

			/**
			 * Field Constructor.
			 *
			 * @param       $value  Constructed by AvadaRedux class. Based on the passing in $field['defaults'] value and what is stored in the database.
			 * @param       $parent AvadaReduxFramework object is passed for easier pointing.
			 *
			...
			function render() {
				...
				// The $this->field variables are already escaped in the AvadaReduxFramework Class.
				?>
